    ...
    <div class="main-body">
        <div class="main-logo">
            <div class="logo-animation-wrapper">
                <div class="logo-animation" ref="logoAnimation">
    ...
    export default {
        ...
        methods: {
            ...
            fitElementToParent(el, padding, exception) {
                this.resize(el, padding, exception);
                window.addEventListener('resize', this.resize(el, padding, exception));
            },
            // main logo animation
            logoAnimation() {
                let logoAnimationEl = this.$refs.logoAnimation;
                console.log(logoAnimationEl.parentNode);
